...
##### [Připojení k Macu](get-started/installation/windows/connecting-to-mac/index.md)
###### [Řešení potíží s připojením](get-started/installation/windows/connecting-to-mac/troubleshooting.md)
###### [Kde je můj Mac?](get-started/installation/windows/connecting-to-mac/visual-studio-ssh.md)
##### [Ruční instalace](get-started/installation/windows/manual-installation.md)
...
#### [Jak se dá přejít na starší verzi produktu Xcode?](troubleshooting/questions/downgrade-xcode.md)
