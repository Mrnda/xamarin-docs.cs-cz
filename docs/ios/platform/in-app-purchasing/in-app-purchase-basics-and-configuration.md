---
title: "Základní informace o nákupy v aplikaci a konfigurace"
ms.topic: article
ms.prod: xamarin
...
> [!IMPORTANT]
> **Poznámka:**: Apple také umožňuje zástupný znak – hvězdičku má být přidán na konec **identifikátor svazku** tak, aby jeden ID aplikace se dá použít pro více aplikací, ale _zástupnému znaku ID aplikace nemůže být použit pro V AppPurchase_. Příklad zástupnému znaku identifikátor svazku může být com.xamarin.*
