...
##  <a name="ios-extensionsiosplatformextensionsmd"></a>[Rozšíření iOSu](~/ios/platform/extensions.md)
...
##  <a name="graphics-and-animation-in-iosiosplatformgraphics-animation-iosindexmd"></a>[Grafika a animace v iOSu](~/ios/platform/graphics-animation-ios/index.md)
...
##  <a name="in-app-purchasingiosplatformin-app-purchasingindexmd"></a>[Nákupy v aplikaci](~/ios/platform/in-app-purchasing/index.md)
...
##  <a name="ios-gaming-apisiosplatformgamingindexmd"></a>[Rozhraní API pro hry v iOSu](~/ios/platform/gaming/index.md)
...
##  <a name="message-app-integrationiosplatformmessage-app-integrationindexmd"></a>[Integrace aplikace Zprávy](~/ios/platform/message-app-integration/index.md)
...
##  <a name="request-app-reviewiosplatformrequest-app-reviewmd"></a>[Kontrola žádosti o aplikaci](~/ios/platform/request-app-review.md)
...
## <a name="exception-marshalingexception-marshalingmd"></a>[Zařazování výjimek](exception-marshaling.md)
