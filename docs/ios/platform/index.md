---
title: Funkce
description: "Dokumenty v této části se týkají funkcí, které jsou specifické pro iOS."
ms.topic: article
ms.prod: xamarin
...
##  <a name="introduction-to-ios-11iosplatformintroduction-to-ios11indexmd"></a>[Úvod do systému iOS 11](~/ios/platform/introduction-to-ios11/index.md)

Postup instalace a začít pracovat s Xcode 9 beta a verze preview 11 podpory pro Xamarin iOS.


##  <a name="introduction-to-ios-10iosplatformintroduction-to-ios10indexmd"></a>[Úvod do systému iOS 10](~/ios/platform/introduction-to-ios10/index.md)

Apple iOS 10 zahrnuje několik nových rozhraní API a služby, které vám umožní vyvíjet aplikace s novými funkcemi a funkce. IOS 10 aplikace mají nové schopnosti, jako je například rozšíření Maps, zprávy, Telefon a Siri. Tato část uvádí hows využít těchto funkcí v aplikaci pro Xamarin.iOS.


##  <a name="introduction-to-ios-9iosplatformintroduction-to-ios9indexmd"></a>[Úvod do systému iOS 9](~/ios/platform/introduction-to-ios9/index.md)

Tento oddíl definuje změny provedené v iOS 9, při upgradu z iOS 8 a používání těchto funkcí v aplikaci pro Xamarin.iOS.


##  <a name="introduction-to-ios-8iosplatformintroduction-to-ios8md"></a>[Úvod do systému iOS 8](~/ios/platform/introduction-to-ios8.md)

Apple iOS 8 z iOS 7 žádost velký počet změny v operačním systému. Zde ukážeme co jsou a jejich použití.

##  <a name="introduction-to-ios-7iosplatformintroduction-to-ios7indexmd"></a>[Úvod do systému iOS 7](~/ios/platform/introduction-to-ios7/index.md)
...
##  <a name="introduction-to-ios-6iosplatformintroduction-to-ios6indexmd"></a>[Úvod do systému iOS 6](~/ios/platform/introduction-to-ios6/index.md)

Vysvětlení funkce byla zavedená v iOS 6, včetně zobrazení kolekcí, předat Kit, Kit událostí a sociálních Framework.

##  <a name="apple-payiosplatformapple-paymd"></a>[Platím Apple](~/ios/platform/apple-pay.md)
...
##  <a name="3d-touchiosplatform3d-touchmd"></a>[3D dotykového ovládání](~/ios/platform/3d-touch.md)
...
##  <a name="ios-extensionsiosplatformextensionsmd"></a>[iOS rozšíření](~/ios/platform/extensions.md)
...
##  <a name="handoffiosplatformhandoffmd"></a>[Aby handoff](~/ios/platform/handoff.md)
...
##  <a name="ios-gaming-apisiosplatformgamingindexmd"></a>[iOS herní rozhraní API](~/ios/platform/gaming/index.md)
...
##  <a name="wide-coloriosplatformwide-colormd"></a>[Široké barev](~/ios/platform/wide-color.md)
...
##  <a name="binding-objective-cbinding-objective-cindexmd"></a>[Vazba Objective-C](binding-objective-c/index.md)
...
## <a name="embedded-frameworksembedded-frameworksmd"></a>[Vložené architektury](embedded-frameworks.md)
