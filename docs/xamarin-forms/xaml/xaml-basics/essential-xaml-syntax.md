...
description: Tento článek vysvětluje základní funkce syntaxe XAML vlastnost elementů a přidružené vlastnosti.
ms.prod: xamarin
...
Protože Android a UWP jsou nastavené na výchozí hodnotu `Padding`, že značka lze odebrat:
