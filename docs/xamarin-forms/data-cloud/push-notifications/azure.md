...
description: Tento článek vysvětluje, jak používat Azure Notification Hubs k odesílání nabízených oznámení z instance Azure Mobile Apps na platformě Xamarin.Forms aplikaci.
ms.prod: xamarin
