...
description: Ovládací prvek DatePicker je Xamarin.Forms zobrazení, která umožňuje uživateli vybrat datum. Tento článek vysvětluje, jak používat ovládací prvek DatePicker v aplikaci Xamarin.Forms.
ms.prod: xamarin
