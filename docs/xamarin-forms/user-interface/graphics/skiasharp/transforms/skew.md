...
description: Tento článek vysvětluje, jak můžete vytvořit nakloněné grafické objekty v SkiaSharp zkosení transformace a to ukazuje s ukázkový kód.
ms.prod: xamarin
