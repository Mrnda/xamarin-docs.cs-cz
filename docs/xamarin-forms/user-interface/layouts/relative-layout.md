...
description: Tento článek vysvětluje, jak vytvořit uživatelská rozhraní, které škálovat podle jakékoli velikosti obrazovky pomocí Xamarin.Forms RelativeLayout třídy.
ms.prod: xamarin
...
`RelativeLayout` slouží k umístění zobrazení na obrazovce relativní vzhledem k celkové rozložení nebo s dalšími zobrazeními.
