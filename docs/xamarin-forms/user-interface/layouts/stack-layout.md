...
description: Tento článek vysvětluje, jak pomocí třídy Xamarin.Forms StackLayout kolekce zobrazení k dispozici prostřednictvím jednu dimenzi.
ms.prod: xamarin
