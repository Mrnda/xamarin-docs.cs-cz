...
> [!NOTE]
> **Poznámka:**: při přepisování `OnBindingContextChanged`, ujistěte se, že základní třídy `OnBindingContextChanged` metoda je volána, aby registrovaná delegáti `BindingContextChanged` událostí.
