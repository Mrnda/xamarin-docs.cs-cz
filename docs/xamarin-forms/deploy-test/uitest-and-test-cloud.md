---
title: Automatizace Xamarin.Forms testování pomocí Center aplikace
...
---
# <a name="automate-xamarinforms-testing-with-app-center"></a>Automatizovat Xamarin.Forms testování pomocí Center aplikace
