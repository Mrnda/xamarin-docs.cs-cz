...
[![Diagram zobrazující základní přehled architektury](architecture-images/mac-arch.png "Diagram znázorňující základní přehled architektury")](architecture-images/mac-arch-large.png)
