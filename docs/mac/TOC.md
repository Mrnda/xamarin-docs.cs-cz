...
### [systému macOS rozhraní API](app-fundamentals/mac-apis.md)
...
### [HttpClient a SSL/TLS implementace selektor](~/cross-platform/macios/http-stack.md?context=xamarin/mac)
