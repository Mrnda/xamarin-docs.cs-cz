...
description: Postup instalace a konfigurace Xamarin.Android pro práci s Visual Studio.
ms.prod: xamarin
...
Tyto články vysvětlují, jak nastavit emulátoru Android pro testování a ladění aplikací Xamarin.Android.
