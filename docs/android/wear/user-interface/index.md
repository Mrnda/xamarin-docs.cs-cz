---
title: Vytvoření uživatelského rozhraní pro operační systém a opotřebením motoru s Xamarin.Androi
description: Vytvoření uživatelského rozhraní pro nosit aplikace operačního systému
ms.prod: xamarin
