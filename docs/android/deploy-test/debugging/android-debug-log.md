...
description: Jak používat protokol ladění ladit aplikace Xamarin.Android.
ms.prod: xamarin
...
-   Zařízení s Androidem virtuální spuštěné v emulátoru systému Android. 
