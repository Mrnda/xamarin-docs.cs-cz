...
description: Tento dokument popisuje základní strukturu UrhoSharp aplikace a odkazy na různá vodítka a ukázkové aplikace, které ukazují, jak používat UrhoSharp.
ms.prod: xamarin
