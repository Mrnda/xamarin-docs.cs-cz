...
description: "Podrobnosti o použití SkiaSharp v vaši platformu. Stručný: obsahují podrobné informace o tom, jak převést váš obsah SkSurface do nativní aplikace."
ms.topic: article
ms.prod: xamarin
