---
title: Vylepšení obnovovací frekvence s CCSpriteSheet
...
ms.locfileid: "33922545"
---
# <a name="improving-frame-rate-with-ccspritesheet"></a>Vylepšení obnovovací frekvence s CCSpriteSheet
...
## <a name="creating-a-sprite-sheet-plist"></a>Vytváření .plist list pohyblivý symbol
...
Pokud chcete používat výsledné soubory, přidejte do projektu CocosSharp .png i .plist. Informace o přidávání souborů do projektů CocosSharp najdete v tématu [BouncingGame průvodce](~/graphics-games/cocossharp/bouncing-game.md). Jakmile jsou přidány soubory, může být načtena do `CCSpriteSheet` znázorněné byl dříve ve výše uvedeném kódu:

```csharp
CCSpriteSheet sheet = new CCSpriteSheet ("sheet.plist", "sheet.png"); 
```

### <a name="considerations-for-maintaining-a-texturepacker-sprite-sheet"></a>Důležité informace pro údržbu list TexturePacker pohyblivý symbol
