...
description: Tento dokument popisuje CCDrawNode, který poskytuje metody pro kreslení primitivní objekty, například řádky, kružnice a trojúhelníčky.
ms.prod: xamarin
