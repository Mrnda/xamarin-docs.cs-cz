---
title: Texture CCTextureCache pomocí ukládání do mezipaměti.
description: Třída CCTextureCache na CocosSharp poskytuje standardní způsob, jak uspořádat, mezipaměť a uvolnit obsah. Je užitečné zejména pro velké hry, které nemusí vyhovovat zcela do paměti RAM, zjednodušuje proces seskupování a uvolnění textury.
ms.prod: xamarin
