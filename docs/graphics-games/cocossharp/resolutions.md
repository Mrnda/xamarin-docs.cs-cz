...
<table>
    <thead>
        <tr>
            <th>Zařízení</th>
            <th>Rozlišení obrazovky</th>
            <th>Příklad – snímek obrazovky</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Požadované zobrazení</td>
            <td>368 x 240 (s černým řádky poměru stran)</td>
            <td><img src="resolutions-images/image1.png" title="368 x 240 (s černým řádky poměru stran)" /></td>
        </tr>
        <tr>
            <td>iPhone 4s</td>
            <td>960x640</td>
