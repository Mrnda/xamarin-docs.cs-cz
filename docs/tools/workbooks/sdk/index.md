...
description: Tento dokument popisuje, jak začít pracovat s Xamarin SDK sešity, které lze použít k vývoji integrace pro sešity Xamarin.
ms.prod: xamarin
