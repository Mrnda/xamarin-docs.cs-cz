...
description: Tento dokument popisuje platformě Xamarin na vysoké úrovni, prohlížení kompilaci proces, přístup SDK platformy, sdílení kódu, vytvoření rozhraní uživatele, vizuální nástroje a další.
ms.prod: xamarin
