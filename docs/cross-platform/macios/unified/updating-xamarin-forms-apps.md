...
description: Tento dokument popisuje kroky, které musí být sledována k aktualizaci aplikace na platformě Xamarin.Forms z rozhraní API Classic unifikované API.
ms.prod: xamarin
