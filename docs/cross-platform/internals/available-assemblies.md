...
description: Tento dokument uvádí sestavení, které jsou k dispozici pro použití v Xamarin.iOS, Xamarin.Android a Xamarin.Mac. Taky obsahuje odkazy na dokumentaci o .NET Standard knihoven a knihovny přenosných tříd.
ms.prod: xamarin
