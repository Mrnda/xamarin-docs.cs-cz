...
Uživatelé Windows musí mít [Visual Studio 2015 nebo 2017 ^](https://visualstudio.microsoft.com/) nainstalován kompilace kódu C# 6 (i v případě, že zvolíte Xamarin Studio pro Windows jako vaše IDE).

^ nebo *[Microsoft sestavení nástroje 2015](http://www.microsoft.com/download/details.aspx?id=48159)* pro příkazový řádek kompilace nebo sestavení servery, například.
