...
description: Tento návod ukazuje, jak vytvářet nativní aplikace Xamarin.iOS a Xamarin.Android, které používají obchodní logiky, které jsou napsané v Visual Basic.NET.
ms.prod: xamarin
