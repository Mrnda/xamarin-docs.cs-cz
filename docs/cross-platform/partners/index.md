...
|[Agentura AMP](https://www.ampagency.com/)|Los Angeles, CA, USA Boston, MA, USA|Agentura AMP poskytuje vývoj softwaru a marketingu služby|
...
|[Cognizant technologickými řešeními](http://www.cognizant.com)|Buenos Aires, Argentina; Auckland, Nový Zéland; Melbourne, Austrálie. Sydney, Austrálie. Brisbane, Austrálie. Brusel, Belgie Paulo po síti SAN, Brazílie; Toronto, Kanada; Šanghaj, Čína; Heredia, Kostarika; Jersey Město, NJ, USA San Francisco, CA, USA Teaneck, NJ, USA|Společnost Cognizant kombinuje nadšení pro klienta spokojenost, technologické inovace, hloubkové odvětví a odborné znalosti procesu a globální, spolupráci pracovní síly, který ztělesňuje budoucí práce|
...
|[Fino Consulting LLC](http://www.finoconsulting.com)|New York, NY|Fino Consulting sestavení výjimečných software, který poskytuje nástroje pro vaše podnikání potřebuje zavaleném vašeho trhu|
...
|[Oakton](https://www.oakton.com.au/)|Melbourne, Město Brisbane, Canbeře, Sydney, Adelaide, Perth|Se službami začátku do konce a řešení a více než 30 let odborné znalosti jsme tu pro zjednodušení technologie, zvýšit vaší flexibilitu, vylepšení zapojení s zákazníky i zaměstnance a více odvodit z vašich investic do technologií.|
|[Obiquitech](http://www.obiquitech.com/)|NSW Sydney, Austrálie|Vývoj nativních aplikací. Všechny platformy.|
|[Ookitech](http://www.ookitech.com.au)|Brisbane QLD, Austrálie|Návrh atraktivních a technologie vedle sebe. Vyvíjíme Chytré produkty, které vám pomůžou tato digitální období.|
|[Orbital8](http://www.orbital8.com.au)|Melbourne, Austrálie|Orbital8 se specialisty na vývoj softwaru ručně vytvořený pro organizace, webové a mobilní platformy. Našim hlavním cílem je neustále doručování inovativní, ale jednoduché a nákladově efektivní softwarová řešení, které poskytují skutečnou obchodní hodnotu pro naše zákazníky. My chceme pride na schopnost interpretovat a předvídat požadavky našich zákazníků a poskytovat řešení, které překročí jejich očekávání. |
|[Čistě řešení](http://www.puresolutions-online.com/Home)|NSW Sydney, Austrálie|Potvrdit týmu odborníků v jejich příslušných polí zanícením se věnuje vytváření nejlepší řešení prostřednictvím fúze obchodním a technologickým.|
|[Readify](http://readify.net)|Docklands VIC 3008 Austrálie|Readify získala globální rozpoznávání pro jejich schopnost pomáhat zákazníkům vytvářejí software, který řídí spolupráce, produktivity, obchodní růst a ziskovost. Jejich schopnost pomáhat zákazníkům je přímý výsledek použití procesů vývoje softwaru osvědčených postupů a použití exkluzivní vývojáři. Jsou to provést prostřednictvím přísné, partner driven náborový proces a pak pokračovat s investicemi do jejich lidé vývoje, zajistit, aby že zůstaly své dovednosti na špici industry knowledge.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[3factr](http://3factr.be/)|Edegem, Belgie|3factr je 100 %, zaměřuje na vývoj Xamarin mobilních aplikací pomocí divers integrace rozhraní API. Theyprovide obou poradenství jako interní vývoj softwaru factory Xamarin IOS, Android a UPW.|
|[CaveBirdLabs](http://www.cavebirdlabs.com/)|Antverpy, Belgie|CaveBirdLabs je vývoj pro mobilní zařízení studio na základě v Belgie, který se zaměřuje na vývoj působivé interaktivní mobilní aplikace|
|[Euricom NV](http://www.euri.com)|Mechelen, Belgie|Vyvíjíme vlastní software s technologií .NET a jazyka JavaScript pro a společně s zákazníka|
|[Tok pilotním nasazení CVBA](http://www.flowpilots.com)|Antverpy, Belgie|Tok pilotním nasazení návrhy, sestavení, nasadí a spravuje digitální nástroje, které pomáhají zákazníkům zvýšit výnosy, snížit náklady nebo přenést svobodu a flexibilitu pro své zaměstnance.|
|[KENZE](http://www.kenze.be)|Mechelen, Belgie|Microsoft .NET projecten en gerelateerde technologieën.  De drie belangrijkste pijlers binnen de organisatie zijn mensen, kennis en mensenkennis, má zij vormen de základ voor kwalitatieve succesvolle projecten en tevreden klanten. |
|[Levelapp](http://www.levelapp.be)|Hoeilaart, Belgie|Nepovedlo se Levelapp úplné mobilní agenturou. jsme fungují jako vývojáři softwaru. Můžeme vytvářet aplikace napříč platformami přizpůsobit a pohonu strategické vize. Můžeme zákazníkům, partnerům a zaměstnancům poskytovat hodnotu. |
|[Realdolmen](http://www.realdolmen.com/)|Huizingen, Belgie; Kontich, Belgie; Lummen, Belgie; Ghent, Belgie; Harelbeke, Belgie; Namur, Belgie; Monsu, Belgie|Mobilní zařízení je novým standardem. Téměř všechny společnosti potřebovat mobilní služby nebo aplikace zůstala konkurenceschopná. Ale mobilních strategie sama o sobě není k dispozici dostatek; všechno, co musí být plně integrovaná v obecné infrastruktury ICT včetně cloudové zabezpečení, ERP a tak dále. Na Realdolmen označujeme to nutně připojené.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Grupo Viceri](http://www.viceri.com.br)|Jundiaí, Brazílie|Poskytujeme web, vývoj pro mobilní aplikace a služby business intelligence|
|[Superactive řešení](http://www.superactive.com.br/)|Brazílie|Superactive é horní paměti empresa especializada em desenvolvimento de soluções tecnológicas inovadoras com foco na TI Estratégica, otimizando processos, de clientes seus ormátu fornecer resultados rápidos e seguros para operačního systému. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Apcurium](http://www.apcurium.com)|Montreal, Kanada|Apcurium vyvíjí mobilní řešení, které se připojují pomocí konkrétní obchodní strategie a uživatelé očekávání dnes mobilní zařízení, platforem a technologií.|
|[BSI Labs](https://bsilabs.ca/)|Toronto, Kanada|BSI Labs je kompletní poradenství, která se specializuje na mobilní strategie, uživatelské prostředí/uživatelského rozhraní návrh, vývoj mobilních aplikací a integrace systémů.|
|[Clearbridge Mobile](https://clearbridgemobile.com/)|Toronto, Kanada|Clearbridge Mobile je společnost vyvíjející mobilní aplikace ukrývá vysoce hodnocený plného zásobníku, která poskytuje služby návrh a vytváření zaměřenou na uživatele a produktu|
|[Kognitivní X Solutions Inc.](http://cognitivex.com)|Moncton, Kanada|Můžeme vytvářet webové a mobilní prostředí |
|[Mozkové média](http://cortex.bz)|Quebec, Kanada|Média mozkové navrhuje mobilní platformy, které se připojují reálné a virtuální, firmy a osoby|
|[Formatec](http://mobile.formatec.ca)|Halifax, Nova Scotia, Kanada|Formatec je soukromě Kanadské podnik, která se specializuje na vytváření a testování softwarových aplikací, které běží na mobilní zařízení, včetně telefonech a tabletech|
|[nventive](http://www.nventive.com)|Montreal, QC|nventive je moderní studio vývoj mobilních aplikací pro iOS, Android a Windows 10 s využitím nejnovějších technologiích.|
|[ObjectSharp Corporation](http://www.objectsharp.com)|Toronto, Kanada|Jako první Microsoft .NET konzultační Partner v Kanadě, ObjectSharp můžou nabízet je úplný rozsah Microsoft vlastní vývoj, školení a služeb pro mentorování: počítači a tabletu "Äì Windows 8 a Windows 7, Phone" Äì Windows Phone, Cloud "Äì Azure. Jejich MVPs Microsoft, vedoucí vývojáři a zkušení školitelé vám pomohou navrhovat, sestavovat a dodávat aplikace lepší a rychlejší.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Bureauet aplikace](https://appbureauet.dk/)|Svendborg, Dánsko|Aplikace Bureauet je společnost vyvíjející aplikaci|
|[Bluefragments](http://www.bluefragments.com)|Kodaň, Dánsko|Bluefragments se specializuje na vývoj aplikací a je certifikovaného partnera Microsoftu.|
|[Přístupových bodů Comet.DK (CometPeople)](http://comet.dk)|Kodaň, Dánsko|Comet je vývoj house, který nabízí vývoj mobilních aplikací pro nejnovější mobilních platformách, jako je iPhone, iPad, Android a Windows Phone|
|[Commentor DK](http://commentor.dk)|Aalborg, Dánsko|Commentor má od 2000 poskytuje důležité podnikové aplikace do největších společností v Dánsko|
|[Miracle](https://miracle.dk/)|Ballerup, Dánsko|Na Miracle usilujeme naše k digitalizační Dánsko přispívat. Provedeme to poskytováním nejvyšší kvality IT řešení pro privátní a veřejné společnosti z našich 3 místech světa Dánsko|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Maven s. r. l.](http://www.maven.do)|Dominikánská republika|Maven je malé společnosti s velkými objemy sny. Jako způsob, jak nabízet čerstvé, nejvyšší kvalitu a rozmanitým softwarová řešení v Dominikánská republika to byla založena 2012. Usilujeme o poskytovat našim zákazníkům pojištěných kvalita vývoje softwaru, a přitom podporovat vztah důvěryhodnosti a odpovědnosti směrem k jejich životní potřeby.|
|[Solvex Dominicana](http://www.solvex.com.do)||Solvex hodnoty profesionálních zkušeností. Společnosti, vytvoření v roce 2014, má teď 200 softwarové inženýry, z nichž více než 80 procent mít 5 a více po několika letech zkušeností poskytování softwaru. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[ITWorx](http://www.itworx.com)|Káhira, Egypt|ITWORX je globální služby IT firma poskytování cloudových a místních řešení přední organizacím celém světě s důrazem na pokročilé analýzy, Enterprise Mobility, správy výkonu a CRM.|
|[Vývoj Jios](https://www.jiosdev.com/)|Egypt|Vývoj Jios je stabilní rychle rostoucí společnost poskytují konzultace technologie a využití poskytovatele služeb, která se specializuje na vývoj vlastních aplikací, služeb cloudových a mobilních aplikací. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Altran (Francie)](http://www.altran.fr/)|Paříž, Francie|Altran je jedničkou díky world v inženýrství a výzkum a vývoj služeb|
|[Arolla](http://www.arolla.fr/)|Paříž, Francie|Arolla je že konzultační společnost specializuje na nejvíce pokročilé techniky vývoje softwaru.|
|[Cellenza](http://www.cellenza.com)|Paříž, Francie|Cellenza je poradenství pro technické znalosti a implementace, výhradně vyhrazený pro technologie Microsoftu a agilní metodologie|
|[Chlórovou](http://www.chloro.eu)|Selestat, Francie|Chlórovou se specializuje na návrh a vývoj vlastní mobilní aplikace, které za cíl přinést zvýšení produktivity a rychlosti odezvy|
|[DevoTeam skupiny](http://www.devoteam.com)|Paříž, Francie|Na Devoteam budeme poskytovat inovativní technologie konzultace pro firmy|
|[Exakis](http://www.exakis.com)|Paříž, Francie|Exakis pomáhá společnostem vyvíjejte inovativní projekty a informace o zabezpečení systému. Uživatel, zaměřuje, vytvářejí řešení založená na technologiích Microsoftu kombinování návrhu a inovace|
|[Ideine](http://ideine.fr/en/ideine/)|Roubaix, Francie|Specialista vývoj pro různé platformy, Ideine navrhuje a vyvíjí vlastní, inovativní a efektivní mobilní aplikace.|
|[Nekonečné čtverec](http://www.infinitesquare.com)|Paříž, Francie|Nekonečné čtverec cílem je navrhovat a vytvářet inovativní softwarových aplikací a kvalitnější zastoupení svých zákazníků, malé i velké podniky, nejlepší vztah důvěryhodnosti a winning společně.|
|[Isiasoft](http://www.isiasoft.com/)|Paříž, Francie Lyon, Francie|ISEO nabízí široké spektrum software development a consultacy služby|
|[La Mobile IT](http://www.la-mobile-it.com)|GRENOBLE, Francie|Nous sommes spécialisés depuis 10 sk dans le mobilní et avons des vztahy étroites avec čísla partenaires klienta et přidá fournisseurs tout ce qui touche, la mobilité a. Nous n'avons aucune exclusivité, si vous désirez obtenir des conseils, devenir partenaire další řešení organizační jednotky nous présenter une, contactez nous!|
|[Matelli služby](http://www.matelli.fr/english/)|Paříž, Francie|Matelli je informace služby společnost založil 2008 k vytváření přizpůsobených obchodních webových a mobilních aplikací pro své klienty.|
|[Procvičte funguje](http://www.mentalworks.fr)|Paříž, Francie|Mentalworks je netypických technologické digitální agentura: obě webové agenturou marketingových e agentura a konzultační podniky / ESN. Tato odborné znalosti umožňující vytvářet weby, mobilní aplikace nebo vlastní obchodní aplikace a integrovat klíče technologickými řešeními.|
|[Oranžové aplikací pro firmy](http://www.orange-business.com/en/contact-us)|Paříž, Francie Curych, Švýcarsko|Oranžová firemní služby je operátor globální telekomunikace a IT služeb společnosti. 20 000 zaměstnanci podporu společnosti, místní vládní instituce a organizací ve veřejném sektoru v každý aspekt jejich digitální transformace. Pomáhají společnosti umožní efektivní spolupráci, pracují efektivněji a lépe zapojit zákazníky "Äì propojení svých uživatelů, servery a počítače, bezpečně a spolehlivě.|
|[Page Up](http://www.pageup.fr)|Dijon, Francie||
|[Rayonnance technologie](http://rayonnance.fr)|Paříž, Francie|Skupina Rayonnance je přední francouzské integrátor specializované pro více než 13 let v implementaci sledovatelnost a mobilní aplikace na terminálu obchodní Windows (Windows Mobile, Windows Phone 8.1, Windows 8), Android, IOS.|
|[SFEIR](http://www.sfeir.com)|Neuilly-sur-Seine, Francie Štrasburku, Francie Lille, Francie Leudelange, Lucembursko|SFEIR est une communauté façonnée par et přidá des développeurs talentueux. Nous créons des aplikace de pointe et relevons avec čísla klienti leurs défis techniky les plus ambitieux.|
|[SOAT](http://www.soat.fr)|Paříž, Francie|Za posledních 15 let se zvětšil SOAT komunita konzultantům a odborníků na technologie, jako je Java – DŽÍ, Microsoft, webové a mobilní zařízení v prostředí agile. Podporují svým zákazníkům v jejich technologické volby, návrh architektury, implementaci a vývoji svých informací a také na kvalifikace sharp, jako je například svoje webové nebo mobilní strategie, jejich migrace na cloud computingu, nebo realizace připojených objektů.|
|[Konzultační Xiomega](http://www.xiomegaconsulting.com/)|Lyon, Francie|Vytvořeno v roce 2014, konzultační Xiomega je konzultační firmu zaměřenou, zaměřuje na konzultační, řízení projektů a další.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[27interactive](http://27interactive.com)|Düsseldorf, Německo Univerzitní nemocnice Hamburg, Německo|Šitý pro různé platformy řešení pro smartphony a tablety s Androidem, iOS, Windows a macOS|
|[VYČK](http://www.aitgmbh.de)|Stuttgart, Německo|VYČK je jednou ze špičkových vývojářů a konzultanty softwaru, která se specializuje na platformě .NET a další. Po mnoho let bylo více ocenění Gold partnera Microsoftu vítězné.|
|[Všechno o Ashley GmbH](http://www.a-gentur.de)|Ibbenbueren, Německo|Všechny informace o uživateli Ashley podporuje společnosti v návrhu a optimalizace IT řešení.|
|[BRICKMAKERS GmbH](http://www.brickmakers.de)|Koblenci, Německo|Pro všechny aktivity Brickmakers, zaměřuje se na projekt ' Äôs úspěchu a výhody. Z důvodu agilní akci během svých procesů je přiřazena maximální transparentnost pro zákazníka. Kromě oblastí koncept, návrh a vývoj jsou také Ochotně převzít odpovědnost za jejich portálů a aplikací uvádění na trh. Díky tomu přivádí jejich prostředí do kompletní životní cyklus digitálních produktů.|
|[BTC AG](http://www.btc-ag.com )|Oldenburgu, Německo|Budeme vyvíjet nová řešení a zadat standardní|
|[CATIS](http://www.catis.de/)|Wolfsburg, Německo Gifhorn, Německo Hannover, Německo Sindelfingen, Německo Ingolstadt, Německo AJAX, Kanada; Mlada Boleslav, Česká republika; Chattanooga, TN|CATIS moderní pracovní jednotka obsahuje už zkušení tým vývojářů aplikací, dokáže shromáždit vaše organizace tak, že vytvoříte šitý firmy a uživatelských aplikací|
|[Cayas softwaru](http://www.cayas.de)|Minden, Německo|Cayas software vytvoří vlastní software pro stolní počítače, aplikace pro Android, iPad a iPhone, stejně jako pro web|
|[Interaktivní FRIDIE, Dietrich & Fritzovi GbR](http://fridie.de)|Stuttgart, Německo|Ve FRIDIE interaktivní vyvíjíme vlastní aplikace a interaktivní Software pro Windows, Android a iOS|
|[Incloud GmbH](https://www.incloud.de)|Darmstadt, Německo|Incloud je Oceňovaný softwarovou společnost, který se specializuje na platformu pro různé podnikové aplikace a konzultační|
|[InfoMantis GmbH](http://www.infomantis.de)|Osnabruck, Německo|Společnost vyvíjející software aplikace pro různé platformy|
|[Intelligentgraphics GmbH](http://www.intelligentgraphics.biz)|Thuringia, Německo|Zaměřujeme se na interaktivní 3D pro prodejní aplikace.|
|[GmbH ISEO Online Marketing](http://www.iseo.de)|Lübeck, Německo|Jsme nedoručí vypnout zátky, ale mají standardní chaloupka hodnoty pro zákazníky, báječný návrhu a prověřená technologie pro každý použití víc než 10 let|
|[msg – systémy ag](http://www.msg.group/)|Berlín, Německo Kolín, Německo Univerzitní nemocnice Hamburg, Německo Frankfurt, Německo Nuremberg, Německo Jersey Město, NJ, USA Je Basel, Švýcarsko; Vídeň, Rakousko|zpráva je skupina nezávislých, mezinárodní společností s více než 6 000 zaměstnanců po celém světě, nabízí holistické služby celé spektrum od kreativní a strategický konzultační a IT řešeními inteligentní, udržitelné a s přidanou hodnotou pro široké spektrum odvětví.|
|[Další GmbH Mnichově](http://www.next-munich.com)|Mnichově, Německo|Určuje, zda B2C, B2B, produktivitu a další strategie zaměřené na mobilní – budoucnost mobilní řešení se teď spustí. Další Mnichově přejde do hloubky a systematicky zabývá všech složek, které přispívají k úspěšné "aplikace firma". Další Mnichově shromažďuje ve všech oblastech návrh a vývoj, umístění a marketingové programy pro mobilní zařízení pomocí 10 let zkušeností.|
|[prodot GmbH](https://prodot.de)|Duisburg, Německo|Prodot rozumí vize svým zákazníkům; fungují ručně spolupráce s vámi ke zmapování požadovaných výsledků. Intuitivní uživatelské rozhraní, elegantní návrhy, technologický znalostí a kontroly pravopisu budoucnost jsou nepostradatelné prvky jejich řešení. Stručně řečeno, efektivní cykly, vyvíjejí stabilní, propracované a dlouhodobých software pro vaše potřeby založené na technologiích Microsoftu a standardní produktů, jako je SAP.|
|[SDX AG](http://www.sdx-ag.de)|Hlavní am Frankfurt, Hesse, Německo Mnichově, Německo Bavorsku|WIR freuen rušit Sie unserem neuen Hauptsitz zasílání rychlých zpráv Frankfurter Westhafen begrüßen zu können. Unsere Büroräume befinden sich im 2. OG zasílání rychlých zpráv Westhafenhaus Speicherstraße 1 unmittelbar neben dem Westhafentower.|
|[SkyTest](http://business.skytest.com)|Erlangen, Německo|Vyvíjíme vlastní nativní a webové aplikace pomocí nejnovějších technologiích napříč platformami jako Xamarin™. Využijte naše dlouhodobá zkušenosti z hlediska. NET™ vývoje a bohaté back-endové služby.|
|[Software2Business GmbH](http://software2business.de/Service/MobileApp/EN)||Software2Business GmbH nabízí komplexní plně službu pro vývoj vaší aplikace – a spolupráci, které budou využívat. Náš Vývojový kanál a nástroje, můžeme použít. |
|[XITASO GmbH](http://www.xitaso.com)|Augsburg, Německo|Poskytuje XITASO konzultační služby zákazníkům B2B, identifikuje možností digitalizaci, optimalizuje obchodních procesů, vytvoří digitální strategie a vyvíjí a inovativní softwarová řešení.|
|[Z√ºhlke](http://www.zuehlke.com/ch/en/)|Curych, Švýcarsko; Frankfurt, Německo Univerzitní nemocnice Hamburg, Německo Hannover, Německo Mnichově, Německo Stuttgart, Německo Vídeň, Rakousko|Vyvíjíme finančně úspěšné produktech, službách a obchodních modelů, od nápadu prostřednictvím implementace – kreslením prostředí 1 000 interní odborníci a víc než 10 000 úspěšné projektů.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Entersoft SA](https://www.entersoft.eu)|Kallithea, Řecko|Entersoft je přední obchodní entreprise softwaru a služeb poskytovatel inovativních a úplný rozsah vysokou kvalitu služeb a podpory zajistit efektivitu optimalizované pro její zákazníky|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Unissoft Technology Co., Ltd.](http://www.inas.online/en/Index.php)|Hongkong|Naše základní technologie za Software pro správu Tsing Hua archivy (nebo TH-AMS™ v krátké) byla doporučené produktu archivy správu Čína stavu po dlouhou dobu, tedy, je také běžně používaný v státní správy, několika oborech, včetně ropy a chemických; v různých firmách například zavlažování funguje metalurgii, telekomunikace a nemovitosti---přes tradiční místní licenčního modelu. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Hroznového řešení](http://grape.hu/)|Budapešť, Maďarsko|Hroznového řešení je společnost vyvíjející software dynamické v 2006. Vyvíjíme primárně vlastních obchodních aplikací pro naše místní i mezinárodní zákazníky. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[GAVS technologií NA celkové](http://www.gavstech.com)|Čennaj, Indie|GAVS Technologies je globální IT služby a řešení zprostředkovatele pro zákazníky, kteří napříč více vertikálně odvětví|
|[Greynubo](http://www.greynubo.com/)|Singapur; Bengaluru, Indie|GreyNubo se skládá z týmu potvrzené odborníky, kteří mají v CRM, CPQ mnoha letech zkušeností domény a mobilní zařízení s velkou provázaností s základnu na platformě Salesforce|
|[MobMaxime](http://www.mobmaxime.com)|Ahmedabad, Indie |Budeme mluvit o svou vizi produktu a rozhodnout se, pokud jsme skvěle hodí pro váš projekt. Pokud se nám, pošleme vám odhadu projektů pro kontrolu.|
|[Automaticky otevírané okno technologie privátní omezené](http://www.popuptechnologies.com)|Bombaj|Automaticky otevírané okno technologie odebrány až 5 lety a od té doby byly testovacího přípravku v mobilním prostředí efektivně pracovali. Sídlo v Bombaj, automaticky otevírané okno technologie je mobilní řešení společnosti neustále znovuobjevování díky novým technologiím. S portfoliem více než 100 + mobilní aplikace mezi všemi platformami – iOS, Android, Windows, Xamarin, Blackberry, Html5, TIZEN a postupné webové aplikace.|
|[Sasken komunikace technologie Limited](http://www.sasken.com)|Bombaj, Indie|Sasken pomáhá lidé zachovají lépe připojené, ať jsou kdekoli. Další obory, včetně automatického electronics, spotřební elektroniku, maloobchodní prodej a zdravotní péče dochází k připojení ke cloudu jako nezbytné spolu s daty řízené a rozhodování v reálném čase. S kompetencí bezkonkurenční domény komunikace a zpracování medií jsou poised na důležité problémy, se kterými se manifesty odvětví. Fungují s jejich protějšky v ekosystému k zajištění nejvyšší služeb v prostředí nové, neustále se vyvíjející propojených zařízení.|
|[ServPRO technologie Pvt Ltd.](http://www.servpro.in)|Bombaj, Indie|ServPRO, značky, který zastupuje "Proaktivně obsluhující" byl v roce 2009 Ruska Pushpinder Bhatia PAN. ServPRO je přední řešení IT a poskytovatel služeb, které jsou vyhrazené pro zajištění důležitých & inovativní řešení IT napříč mnoha svislé segmenty včetně způsobem & oděvů, maloobchodního prodeje, ropy a plynu, Pharmaceuticals, výrobní, bankovnictví, Agro, FMCG/CPG zlatem, EXIM a různé další vertikální vazby odvětví.|
|[Taritas Software Pvt řešení. Ltd.](http://www.taritas.com/)|Bengaluru Karnataka, Indie Jabalpur Madhya Pradesh, Indie|Taritas je outsourcing softwarovou společnost, která dodává řešení špičkových pro řadu oborů. Komplexní informace o softwaru a vývoj aplikací v kombinaci s poskytuje náklady, umožňuje nám poskytovat vysoce kvalitní vývojářských služeb primárně zaměřen na minimalizaci nákladů na projekt a maximalizaci zisku našich klientů. Budeme postupovat podle přístupu "Vpravo poprvé, včas a v mezích rozpočtu". |
|[Odborný Mahindra](https://techmahindra.com)|Bengaluru|Odborný Mahindra představuje propojeném světě, nabízí inovativní zaměřeného na zákazníky informačních technologií a služeb řešení umožňuje podnikům, přiřadí a společnosti na vzestupu ' z vnitřního převodu. Nepovedlo se společnost 4.4 miliard USD s odborníky v oblasti 117,600 + napříč 90 zemí, pomoc přes 840 + globální zákazníků, včetně společností Fortune 500.|
|[TechAhead Pvt softwaru. Ltd.](http://www.techaheadcorp.com)|Princetonské Newarku; Noida, Indie|Vytváříme řešení mobility, která zrychlení digitální transformace síti na pracovišti, zvýšit produktivitu, vynucení zabezpečení a umožněte uživatelům pracovat odkudkoli a na kdykoli. Vyvíjejte řešení mobility přizpůsobená pro váš model enterprise a obchodních cílů, které dokonale resonate s vnímání značky, oblibě, integraci služeb a očekáváním zákazníků.|
|[Procházení stromu konzultační služby](http://www.walkingtree.in/)|Hyderabad, Indie|Procházení stromu je IT software a služby poskytovatele rozpoznán pro své nadšení pro technologie. Působí jako vývojový tým produktu nebo technický tým back-endu pro zákazníky po celém světě.|
...
|[S. Gaia r. l.](http://www.gaia.is.it/en/)|Milán, Itálie|Gaia je společnost návrhové prostředí, který vytváří digitální ekosystémů určená pro lidi.|
|[S. Giuneco r. l.](http://www.giuneco.it/)|Florencie, Itálie|Cílem společnosti je využívat nové technologie (hlavně souvisejících s Microsoft world) k vytváření účinný a efektivní řešení v značnou pozornost (UX) použitelnosti a udržovatelnosti|
|[Lemcube](http://www.lemcube.com)|Paese Treviso, Itálie|Poradenské společnosti s 10 let zkušeností s využitím Microsoft .net. Naši zákazníci jsou obory, logistické, údržby a mobility. Můžeme nabízet odbornému vedení a školení na úloze.|
|[Mahiz Srl](http://www.mahiz.it/)|Itálie|Artisans softwaru Mahiz pomáhá společnosti na vytváření lepších produktů, poskytování dvacet let zkušeností v oblasti informačních technologií. Jejich cílem je identifikátorů rid ve světě chybný softwaru, které blokuje vývoje produktů, procesy a nápady. |
|[Proge softwaru](http://www.progesoftware.com)|Řím, Itálie Milán, Itálie|Budeme mít vyrábí projekty s vysokou technického obsahu pro střední a velké společnosti, celonárodně i, od 1985. Budeme poskytovat všechny nezbytné pro návrh, vývoj a údržbu systému pro podnikové IT aktivity|
|[PS Mobilní srl](http://www.psmobile.it)|Bologna, Itálie|PS Filozofie pro mobilní zařízení podle dialogu; naslouchání na zákazníka a společně definování strategie. Tohoto úspěšnou je nutné odsouhlasit potřebám uživatelů, obchodní cíle a možností, které platformy. Svého vývojářského týmu poskytuje vynikající výkon z hlediska grafiky, technologie a činnost koncového uživatele a bere v úvahu zvláštní aspekty zvolenou platformu.|
|[SOFOS snc](http://www.sofos.it )|Bologna metropolitních Bologna Město, Itálie||
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Podniky rozsivek](http://www.diatomenterprises.com/)|Riga, Lotyšsko|Vyvíjíme jednotlivé webové, mobilní a desktopové systémy, které Využijte sílu naší firmy osobnosti klientů|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Bit řešení a konzultační služby GmbH](https://www.bitsolutions.ch)|Balzers, Lichtenštejnsko|Bit řešení a konzultační služby vyvíjí jednotlivých webových, mobilních a desktopových aplikací|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[AGILUX](https://agilux.lu)|Pommerloch, Lucembursko|Agilux je počítač konzultační společnost, která se specializuje na integraci IT řešení pro komerční správy a monitorování účtů z malé a střední podniky, vývoj webů, elektronického obchodování a mobilních aplikací|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Tím chemii v kódu](http://www.codechem.com)|Skopje, Makedonie|Tím chemii v kódu poskytuje vývoje softwaru, řízení projektů a konzultační služby. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Alset](http://alset.com.mx)|Mexico City, Mexiko|ALSET je, že společnost specializovaný v informačních technologií (IT) s rozsáhlých zkušeností v odvětví poskytnete stav moderní, pokročilé, spolehlivé a robustní řešení|
|[Gigigo skupiny](http://www.gigigo.com)|Mexico City v Mexiku; Paulo po síti SAN, Brazílie; Madrid, Španělsko|2004, která tyto letech Gigigo stal solid a spolehlivé digitální ally, dokáže směrovat a doprovodných velké společnosti prostřednictvím jejich cestu k digitální transformaci|
|[InfoTacto](http://infotacto.com)|Mexico City, Mexiko|Nepovedlo se víceoborové skupinu Odborníci v oblasti s rozsáhlých zkušeností v řízení rizik, stavu, číslo sociálního pojištění (plány důchodu a sociální výhodu schémata), bezpečnost veřejnosti, technologie hotelu odvětví a počítače.|
|[De CV Lisyx technologie SA](http://www.lisyx.com)|León Guanajuato|Lisyx technologie je konzultační společnost, zaměřuje na řešení pro informační technologie a obchodní procesy. Poskytují konzultační služby v obchodní s přidanou hodnotou a služeb IT outsourcingu a řešení nové technologie.|
|[Migesa](http://www.migesa.com.mx/)|Monterrey, nový Leon, Mexiko; Mexico City, CDMX, Mexiko|K dispozici na trhu po víc než 35 let Migesa je jedním z největších informace a technologie komunikace služby a řešení integrátor. Jsme návrh a implementace šitý řešení pro potřeby střední a velké podniky.|
|[RAMSCT SC](http://www.ramsct.com )|Mexico City|Znak empresa nivel mundial se encuentra actualmente evaluando la mejor manera de utilizar soluciones móviles dentro de su negocio. Nuestra experiencia en soluciones móviles por más de 10 años čísla permite ofrecer soluciones totalmente integradas incluyendo:  |
|[De CV TotalTech SA](http://www.totaltech.com.mx)||omos expertos en desarrollo de aplikace para iOS, Android a Windows Phone. |
|[Xherstone](http://www.xherstone.com)|Naucalpan de Juárez Mexiko|Xherstone je software, web a vývoj pro mobilní zařízení společnosti pracující na špičkové technologie, z opensourcových k přizpůsobení. Spojili jsme obchodní znalosti a technologické prostředí.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Agilní technologie ](http://www.agiletz.com)|Dubai, Spojené arabské emiráty; Kuvajt; Omán; Bahrajn; Katar; Káhira, Egypt|Agilní Technologies je organizace IT poskytuje poradenství, vzdělávání a služby kolem DevOps, vývoj a testování služby poskytovatele řešení.|
|[CodeValue](http://www.codevalue.net)|Herzliya (Izrael); Yokne'am Illit, Izrael|CodeValue je přední společnost softwaru poskytuje celé spektrum softwarových služeb, které umožňují zákazníci můžou soustředit na své základní obchodní aktivity|
|[CUBE](http://www.dcube.me/)|Rijád, Saúdská Arábie|CUBE se specializuje na vývoj elektronických médií a reklamy s misí world Arabské Internet poskytovat nejlepší prostředí výroby a pracovat s nimi elektronického obsahu|
|[DigiPresence](http://www.digipresence.net)|Dubai, Spojené arabské emiráty|Přítomnost Digi poskytuje, nainstaluje a poskytuje technické podpory a údržby služby generální ředitelství pobytu zahraničí Dubaj a jeho cizí centra.|
|[TechSource LLC](http://www.techsource.ae/)|Dubai – Spojené arabské emiráty|Naše služby sahají od vývoje aplikací a údržbu, integrační řešení ERP, CRM a funkční Consulting services. Během posledních několika let jsme dodali výrazné zlepšení výkonu na trhu lídrů na Středním východě.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Caesar odborníků](http://www.caesarexperts.nl/)|Utrecht, Nizozemsko|Odborníci Caesar navrhuje, sestavení, implementuje a spravuje výkonné, inovativní řešení ICT.|
|[Dalosy](https://dalosy.com)|Hendrik. Ido Ambacht, Nizozemsko| Dalosy poskytuje mobilní řešení, které splňují specifické potřeby a obtíže spojené s různými společnostmi a obory|
|[Elastique](https://www.elastique.nl/)|Hilversum, Nizozemsko|Elastique se společnost vyvíjející inovativní aplikace|
|[EsperantoXL](http://www.esperantoxl.nl)|Utrecht, Nizozemsko|EsperantoXL specialises při vývoji inteligentní softwarová řešení. Můžeme pomoct organizacím zlepšovat jejich efektivitu tak, že usnadňuje svých procesů|
|[Finaps](https://www.finaps.nl/)|Amsterdam, Nizozemsko|Finaps doručuje inovativní řešení IT pomocí pokročilé technologie, jako je Mendix, SAS, Xamarin a pole.|
|[Uvolnění](http://www.freed.nl/)|Achtkarspelen, Nizozemsko|Uvolněné developes webových a mobilních aplikací pro iOS, Android a Windows |
|[Holygrow](http://www.holygrow.nl )|Den Ana Capelle IJssel, Nizozemsko|Prostřednictvím našich kreativity, znalostní báze, prostředí a nadšení vytvoříme smysluplné digitálních produktů. Provedeme to pomocí následující čtyři se řídí zásadou.|
|[Internet Solutions i Pulse](http://www.i-pulse.nl)|Doetinchem, Nizozemsko|Můžu – pulse sestavení vlastní software, který i web, aplikace a další|
|[Ijsberg konzultanty](http://www.ijsbergconsultants.nl)|Amsterdam, Nizozemsko|Ať už jde o obchodním modelu, strategie, inovace, vývoj produktů, zákazníků orientace nebo komunikace, IJsberg pomáhá organizacím do aplikace excel. Provedeme to při přípravě důkladné integrovaný přístup|
|[Informace o podpoře B.V.](http://www.infosupport.com)|Veenendaal, Nizozemsko Mechelen, Belgie|Informace o podporu se specialistou ve vývoji, Správa a hostování vlastní software a doručení řešení BI a integrace|
|[iQuality](http://www.iquality.nl)|Nijmegen, Nizozemsko|Jsme navrhování, vývoje a podporují softwaru, aplikace a weby na základě záměrů našich zákazníků. |
|[KEMBIT B.V.](http://www.kembit.nl/)|Wijnandsrade, Nizozemsko|Díky předvídání monitorovaných vývoj a výsledné potřebám jsme zavést a realizaci odpovídající, kvalitativní, inovativních a inteligentních řešení IT.|
|[Konzultační KPN](https://www.kpnconsulting.nl/)|Zoetermeer, Nizozemsko|KPN vaší vize je, že je mnohem víc než nasazení technologie. Zvýšení vigor lidí a organizace je jejich prioritu.|
|[Logirix](http://www.logirix.com/en/)|Groningen Groningen|Logirix zajišťuje uživatelsky přívětivější a funkční rozhraní, které musí koncoví uživatelé napojení organizační procesy a data|
|[Macaw Nederland](http://www.macaw.nl)|Schiphol Rijk, Nizozemsko Barendrecht, Nizozemsko Apeldoorn, Nizozemsko|Macaw navrhuje, sestavuje a spravuje digitálním technologiím, které řešení pro office mobile, online a domovské. Jsou odborníci v oblasti integrace podnikových, spolupráce, cloud, automatizace marketingu, obchodní analýzy a outsourcingu.|
|[Nové Mobile Nexus](http://www.newnexusmobile.nl)|BW Amsterdam|Nová mobilní řešení Nexus sestavení aplikace pro firmy a uživatelů pro všechny platformy. Nová mobilní řešení Nexus provede organizace v celém procesu: z consulting o realizace a implementace až po její údržbu.|
|[Otevřete řešení kruh B.V.](http://www.opencirclesolutions.nl/en/)|Eindhovenu, Nizozemsko|Otevřete řešení kruh má poslání, aby lidé a klientů úspěšně prostřednictvím znalostní báze a inovace. Reagovat na to a použijte Open Source technologií pro: obchodní aplikace, mobilní aplikace, integrace, business intelligence a vývoj produktů. Budou věřit, že ve vlastních řešeních pro Agile/Scrum přístup neudělí projektové manažery, kteří většinou pracují PRINCe2 metody.|
|[Ordina ICT](https://www.ordina.com)|Nieuwegein, Nizozemsko Groningen, Nizozemsko Amsterdam, Nizozemsko Eindhovenu, Nizozemsko Apeldoorn, Nizozemsko|Ordina dosahuje jejich poslání generování udržitelné inovace ve spolupráci s klienty. Jejich dosáhnout kováním zavřít vztahů s klienty. Tyto začínat investice do vzájemnou důvěryhodnost a principy. Ale to je jenom začátek; chtějí se poskytují udržitelné řešení, které uživatelům pomáhají skutečně posunout vpřed. Projekty a programy vyvinutý bez plýtvání man hodin a prostředků, které co se mají provést, a se dají snadno spravovat, který pak znamená, že mají dlouhé životnosti.|
|[Bod 42](http://www.point42.nl)|Reeuwijk, Nizozemsko|Smartphony en tablety halen de gewone počítač v tempo alamování řádků v min aantal gebruikers. Uitstekende gebruikservaring op mobiele apparaten je hierdoor belangrijker dan ooit. Bod 42 werkt altijd vanuit lená Upřednostňujícím mobilní en gedachte en spitst zijn dienstverlening porážky op responzivní webdesign.|
|[Rychlé kruh BV](http://www.rapidcircle.com/)|Amsterdam, Nizozemsko Puné, Indie Melbourne, Austrálie|De digitale werkplek je de vervanger van het bureaublad op de PC. De online varianta je echter altijd beschikbaar ook op mobiele apparaten. Voor de (mobiele) digitale werkplek rollen jsme de standaard versie van Office 365 uit. |
|[Redhotminute](http://www.redhotminute.com)|Tuil, Nizozemsko||
|[Rubicon](http://www.rubicon.nl/diensten/mobiele-apps)|Postbus 169, 4130 ED Vianen|Van visie tot strategie, návrh tot vývoj aplikací, integratie splněny ERP, testen, beheer en cloud. Wij hebben kennis van en ervaring splněny het bouwen van mobiele oplossingen kostka passen bij uw individuele behoeften en kansen. Rubicon ontwerpt, ontwikkelt, testování, nasadí en beheert aplikace. Splnění onze "Mobilního DevOps aanpak" zorgen jsme voor lená voorspelbare betrouwbare en inzichtelijke ontwikkel-en beheeraanpak voor uw aplikace.|
|[Versluis](https://gerald.verslu.is/)|Sittard, Nizozemsko|Chvíli o hlavně zaměření na vytváření aplikací, zejména po prostředky Xamarin a všechno, co musíme s ním dělat. Ale aplikace není kompletní bez správného back-endu, pravé? Ano nebojím některé technologie ASP.NET (Core) nebo jiné webové aplikace. Chci také pustíte do optimalizace kolem s celou řadou dalších věcí, jako je třeba: průběžné doručování a průběžnou integraci, všechno, co Azure,|
|[Xablu](http://www.xablu.com/)|Amsterdam, Nizozemsko|Doveďte aplikaci vývojový tým se aplikace Xamarin vývoj řešení, od sestavování vývojové týmy a společně sourcing vytváření standardních vývojových prostředích.|
|[Xpirit Nederland B.V.](https://xpirit.com)|Hilversum, Nizozemsko|Vážně zabýváte některými odborníky v oblasti technologií, ochoten a schopen provádět věci jinak. Xpirit jsou inovátory transformace předpokladů a první uživatelé, kteří si osvojí změnit. Odborníci v oblasti nových technologií společnosti Microsoft.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Enlighten návrhy)](https://www.enlighten.co.nz)|Auckland, Nový Zéland|Enlighten () existuje vám výjimečně navržené a inovativních a technologickými řešeními pro celý svět zaměřených na zákazníka. Vytvoření aplikace v jazyce C# pro iOS, Android a Windows používají technologie Microsoftu|
|[Ltd hydrogen aplikace](http://www.hydrogenapps.com)|Auckland, Nový Zéland|S využitím víc než dekádu zkušeností úspěšně doručování velkých škálovacích platforem po celém světě, přináší Hydrogen bohatými zkušenostmi v doručování vynikající softwaru a novou éru aplikace, nastavení mobilních zařízení a vývoj her|
|[Ltd magnetického řešení](https://www.magnetismsolutions.com/)|Auckland, Nový Zéland; Christchurch, Nový Zéland|Můžeme dostat spuštění provádění každé CRM, které poskytujeme našim. Více než 1500 z nich s byl úspěšně spuštěn, jsme velmi hrdá naše různorodým a široké rozsahu portfolia. Naše zkušenosti při implementaci CRM mezinárodně znamená, že jsme také umístěn k poskytování řešení CRM. |
|[Zebra přechod](http://zebracrossing.co.nz/)|Taranaki, Nový Zéland|Technologii používáme pro obchodní inovace. Partnerství s někým, kdo bude naslouchat, se dozvíte cílů a doručování, budete potřebovat.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Pokročilé systémy technologie](http://www.astechoman.com/)|Maskat, Omán|AstechOman je poskytovatel řešení IT. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Haiyan Group Inc.](http://www.haiyan.com.ph)|Manila, Filipíny|Haiyan Group Inc. developes webových a mobilních aplikací pro iOS a Android|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Applandeo](http://www.applandeo.com/en/)|Krakow, Polsko|Applandeo je společnost vyvíjející aplikaci a web|
|[S.A. ASSECO POLSKO](https://pl.asseco.com/)|Rzeszów, Polsko|Polsko Asseco vyvinula technologicky pokročilé softwarová řešení pro společnosti a instituce všechny klíče sektory ekonomiky více než 20 let|
|[Billennium](http://billennium.pl/)|Varšava, Polsko |Billennium má mnoho let zkušeností s vývojem inovativní obchodní nástroje a řešení.|
|[Okraj o.o. z jednoho řešení Sp.](http://www.edge1s.com)|Varšava, Polsko |Poskytujeme znalosti a zkušenosti vysoce kvalifikovaných odborníků na IT. V rámci každé služby v našem portfoliu garantujeme flexibilní přístup, který potřebám a požadavkům klienta|
|[Z o.o. NETBULLS Sp.](http://www.netbulls.io)|Bialystok, Polsko|Získejte své nápady na trh skilfully. Bez plýtvání £$ €, čas nebo výmluv. |
|[SII](http://www.sii.pl/en)|Varšava, Polsko Paříž, Francie Madrid, Španělsko; Berlín, Německo Amsterdam, Nizozemsko Brusel, Belgie Město Luxembourg, Lucembursko; Geneva, Švýcarsko; Marrákeši, Maroko Praha, Czechia; Bukurešť, Rumunsko; Toronto, ON, Kanada; Santiago, Chile, Santiago de Chile metropolitní oblasti; Buenos Aires, východní Argentina, autonomní město Buenos Aires; Bogotá, Bogota, Kolumbie; Dillí, Indie|SII je přední IT služeb společnost v Polsko podporující digitální transformaci programy z jeho koncepci úspěšné dodání a. Poskytujeme znalosti týkající se doručování aplikací podniky a koncové uživatele nejdříve povolení komunikace zařízení, velké objemy dat, zpracování a offline.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Agap2](http://www.agap2.com)|Lisabon, Portugalsko|Agap2 – Evropského poradenství provozní a technické skupiny specializované v oboru a IT|
|[Uhlíkový podle TUČNÉ](http://www.carbonbybold.com/)|Lisabon, Portugalsko|Uhlíkový podle tučné písmo, je určitou značku, zaměřuje na mobilní konzultační služby pomáhal společnostem mobilní integrovat do své obchodní strategie. |
|[WIG](http://www.wig.pt)|Lisabon, Portugalsko|WIG má pozitivní organické a přizpůsobené poloze. Zobrazí klienty jako partneři a Žijeme případné problémy, jako by byly náš. Výsledkem je vždy kladné, flexibilní, skutečné a pragmatický.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Binwell Ltd.](https://www.binwell.com)|St. Petersburg, Rusko|Binwell navrhuje a vytváří vlastní software, poskytování dobře inženýrství řešení. Jsme pusťte z obchodní potřeby a seznamte se přesně 'value' přeneseme do klienta v každém kroku|
|[Notissimus](http://notissimus.com)|St. Petersburg, Rusko|Funguje prodejní nebo služby společnosti? Přejdete na správném místě. Nové projekty jsou vždy Vítejte. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[INSSIO](http://inssio.com)|Bělehrad, Srbsko|Z projektu koncepci pro aplikaci zavádění INSSIO změní své nápady obchodní software, který vaši firmu|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[CyanSYS](http://www.cyansys.com)|Singapur; Kuala Lumpur, Malajsie; Makati, Filipíny; Hongkong; Kota Kinabalu, Malajsie, Sabah; Jakarta, Indonésie|CyanSYS se snaží poskytovat škálovatelný a kvalitní řešení pro malé a střední společnosti, povolovat konkurovat & růst prostřednictvím informačních technologií|
|[Xamariners](http://xamariners.com/)|Singapur|Při sestavování aplikace, které běží nativně na iOS, Android, Windows a Mac pomocí jediného základu kódu, jakož i popisný roboty a rozšířené Reality aplikace.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Logamic](https://www.logamic.com/)|Bratislava, Slovensko|Pokud chcete přidat vyhrazenou pro vývojáře v Xamarinu pro váš tým nebo si přejete nám pro kompletní proces vývoje pro vás nebo pokud právě chcete poradit Xamarin vývoje pro mobilní zařízení bez obav, že nás. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[AD softwarové systémy](http://www.adsoftsystems.co.za)|Kapské Město, Jihoafrická republika|Systémy softwaru AD nabízí vlastní webové a mobilní řešení pro vývoj. Zaměřují se na nativní vývoj, ale také vytváření řešení umožňující maximální znovu použít pro všechny hlavní mobilní platformy|
|[CodeWrite Pty Ltd](http://www.codewrite.co.za/)|Johannesburg, Jihoafrická republika|Zaměřujeme se na mobilní zařízení na základě aplikace a webové řešení, bohaté přizpůsobené podnikové softwarových aplikací a integrace software systému řízení přístupu k zabezpečení|
|[Cyberlogic Pty Ltd](http://www.cyberlogic.co.za)|Kapské Město, Jihoafrická republika|Cyberlogic je spravovaná služba poskytovatel cloudu a spravovaných služeb IT s datovými centry|
|[Plný zásobník](http://www.fullstack.co.za/)|Kapské Město, Jihoafrická republika|Plný zásobník je softwarová společnost poskytující data produkty a služby navržená tak, aby odemknout obchodní hodnotu díky poskytování kvalitního softwaru včas za pevnou cenu.|
|[Nové Media Labs](http://www.newmedialabs.com)|Kapské Město, Jihoafrická republika|Jsme specializují zabezpečené a transakční webových aplikací pro klienty z oboru finančních služeb. Tyto systémy bespoke jsou plně integrované s naší firmách poskytovat významná vylepšení efektivity a možnosti zapojení zákazníků.|
|[Paradigma skupiny](http://www.paradigmgroup.co.za/)|Kapské Město, Jihoafrická republika|Skupiny paradigma se specialistou na produkty rozdělení vývoje softwaru ve skupině. Vývoj vlastního softwaru pro podniková, nevládních organizací a instituce státní správy dělají.|
|[Konzultační Sabersoft](https://www.sabersoft.co.za/)|Jihoafrická republika|Podniky mohou nyní výhod mobilní aplikace oslovit nové trhy, získali povědomí, vylepšovat poskytování služeb a nakonec zvýšení výnosů.|
|[Tangens IT řešení](http://tangentsolutions.co.za/)|Jihoafrická republika |Tečný řešení byla založená v 2010 a je konzultační domu digitální transformace vývoje. Jsme jsou open source, zaměřuje a Užijte si účastní rychlé tempem a neustále se měnící technologické ekosystém. Jsme první cloudové, první DevOps a první mobilní zařízení. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[DevsDNA](http://www.devsdna.com)|Sevilla, Španělsko|Na DevsDNA jsme myslíte, že jiný způsob řešení podnikající a vytváření softwaru je možné. Bohužel náš moderní společnosti chybí transparentnosti, etickými, zásady a osobnostní compass.|
|[KutirTech](http://www.kutirtech.com)|Malaga, Španělsko  |Po víc než 13 let jsme byly sestavování a podpora webových a mobilních aplikací pro klienty malé i velké organizace. Jsme neustále prozkoumat a experimentovat s nejlepší v třídě nástroje a technologie a přineste správné kombinace nástroje a dovednosti, které zajistí úspěch naši podnikoví klienti.|
|[Pasiona Consulting S.L](http://www.pasiona.com)|Barcelona, Španělsko|V místním prostředí, naslouchání a zapojení zákazníků v dialogu je nejlepší způsob, jak poskytnout inovativní technologickými řešeními, které jsou podle konkrétních potřeb jsme byly založil 2007. To znamená jeho posláním a naše raison Äôetre d ". Nasloucháme konzultační společnost specializuje na vývoj přizpůsobená řešení pro každou společnost, protože každý klient je jiné a vyžaduje jedinečný a výhradní zpracování. Naším cílem je inovace, vysoce kvalitní práce, průběžné trénování a hodnota lidské teaRegional Premier|
|[TalentoMobile](http://www.talentomobile.com/)|Španělsko |Nepovedlo se digitální natives. Jsme digitalizaci vašich obchodních procesů a připojení se zákazníky, jak pomocí našich řešení a naše produkty.|
|[Vass Consultoria de Sistemas](http://www.vass.es/en)|Madrid, Španělsko; Barcelona, Španělsko|VASS je IT konzultaci s pevně založil v roce 1999, vysoce specializované v nové technologie a integrované produktech a službách s důkladné znalosti a mimořádných technologie. Jsou společnosti se vymazat závazkem mezinárodní rozšíření činné v několika zemích v Evropě a amerických. VASS je společnost potvrzené společnosti útraty zisk na sociálních sítích akce % 2.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[BITZEAL](http://www.bitzeal.se)|Göteborgu, Švédsko|Díky Bitzeal webové aplikace, aplikace pro telefon a plochy a firmwaru|
|[Conevo IT Consulting AB](http://www.conevo.se)|Stockholm, Švédsko|Poradenské společnosti IT, prostřednictvím skvělé rychlost odezvy pro své klienty podnikání, vytvoříte IT řešení nejlepší a nejvíce udržitelné efektivní a humble způsobem je Conevo|
|[Provádění ve vlnách.](http://www.makingwaves.com)|Stockholm, Švédsko|Provádění ve vlnách. platí strategie návrhu a technologické služby usnadňují bold podnikům transformovat na úspěšné digitální firmy. S více než 300 zkušený a velmi se zajímám odborníky jsou to inovace partnera, který nabízí všechno, co potřebujete k digitální vítěze.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Arendi](http://www.arendi.ch/)|Hombrechtikon, Švýcarsko|Arendi poskytuje širokou škálu služeb: vývoj aplikací, vývoj hardwarových a firmwarových a řízení projektů |
|[Skupina dostupnosti služeb BBV softwaru](http://www.bbv.ch)|Curych, Švýcarsko|BBV softwarové služby se švýcarský software a konzultační společnosti. Vyvíjejí mobilní řešení, které jsou přizpůsobené pro vaše konkrétní a komplexní požadavky.|
|[Noser Engineering AG](http://www.noser.com)|Winterthur Curych |Noser je Gold Partner Microsoftu pro vývoj vlastních, mobilních a obchodních řešení. Microsoft má s názvem Engineering AG Noser Gold Certified Partner společnosti Microsoft jako vítěze ocenění partnera Microsoft Application Lifecycle Management (ALM) 2012. Tato ocenění rozpozná nezpracovaných odhodlání dodávat řešení inovativní technologie a software v nejvyšší kvalitě prostřednictvím ALM nejlepší výkon.|
|[SPRL synapsis skupiny](http://www.synapsis-group.com)|Brusel |Náš tým pro vývoj softwaru má dlouhou záznam sledování úspěšné šitý a pevnou cenou vývoj pro malé a velké společnosti. Na ploše, webových nebo mobilních platformách (iOS/Android/Win8), máme všechny prostředky, které budete muset posunout vpřed s projektem.|
|[TechTalk](http://www.techtalk.at)|Vídeň, Rakousko; Curych, Švýcarsko|Jsme vám přinášejí to nejlepší vývoji softwaru, ušetříte čas i peníze při současném zachování kvality. |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[iScreen Corporation](http://www.iscreen.com)|Taipei, Tchaj-wan|iScreen vytvořila základu na plné technologii s podnikovým zaměřit se na konzultační, návrh a tvorbu webových a libovolnou mobilní platformu aplikace|
|[Informace o JetFusion Co., Ltd.](http://www.jetfusion.com.tw/)|Tchaj-pej|Poskytujeme vývoj vysoce flexibilní, v reálném čase a profesionální softwaru a služeb konstrukce systému a také poskytují kompletní podnikové řešení informace o systému.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Hologram LTD](http://hologramsoft.com/)|Istanbul, Turecko|Hologram LTD je house vývoj univerzální softwaru, práci v obou firemní a herní místa, zaměřuje se na více platforem|
|[Mobilist Bilisim Sistemleri](http://www.mobilist.com.tr)|Istanbul, Turecko|Sestavili jsme vysoce kvalitní Technické týmy a inteligentní návrhy zobrazíte inovativní řešení.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Adaptivní finanční konzultační Limited](http://weareadaptive.com)|Londýn, Spojené království|Poradenství s rozsáhlých zkušeností v odvětví finančních je adaptivní finanční omezené poradenství|
|[Apptelic Ltd](http://Apptelic.com)|Londýn, Spojené království|Apptelic Ltd je společnost vyvíjející software, která se specializuje na vývoj mobilních a desktopových aplikací pro iOS, Android, Windows a Xbox One.|
|[AppXib Ltd](http://www.appxib.com)|Peterborough, Spojené království|AppXib je společnost vyvíjející aplikaci|
|[Modré Sparrow aplikace](http://www.bluesparrowapps.com/)|Bristol, Spojené království|Modré Sparrow aplikace je ocenění vítězné aplikace pro vývojáře společnosti|
|[Objekt pro vytváření aplikací Chelsea](http://chelsea-apps.com/)|Londýn, Spojené království|CAF provedl rychle název sama za sebe jako přední společnost vyvíjející mobilní aplikace Spojené království a národ největší specialista mobilní poradenství pro příjemce a podnikových aplikací|
|[Kódovanou Ltd Londýn](http://getcodified.com/)|Londýn, Spojené království|Londýn je vedoucí agentura React Native a Xamarin|
|[Cohaesus](http://cohaesus.co.uk)|Londýn, Spojené království|Cohaesus sestavení nativních aplikací pro některý ze světy největší značek, všechny smluv v systémech iOS, Android a Windows|
|[Contemi](http://www.contemi.com)|Lysaker, Norsko; Čtení, Spojené království|Contemi je vývoj IT a obchodní podnik poradenství vyvíjíte software pro a s iniciativami objem požadovaný při spuštění.|
|[Kreativní Sciences](https://creativesciences.co.uk)|Londýn, Spojené království|Kreativní vědy poskytuje mobilních a vývoj pro web, poradenství, desing a služby podpory. |
|[Datadruid](http://www.datadruid.co.uk)|Společnosti Bishop Stortford, Spojené království|Poskytuje robustní a vysoce výkonné aplikace a služby externího vývoje. Rychlé a cenově|
|[Eastpoint softwaru](https://www.eastpoint.co.uk/)|Londýn, Spojené království|Máme kompletní vývoj house poskytnutí strategie a plánování, návrhu a uživatelského prostředí, vývoj, testování a údržby a podpory|
|[Element čtyřicet devět](http://www.elementfortynine.com)|Londýn, Spojené království|Element čtyřicet devět je mobilní poradenství, zaměřuje se na aplikace, specializující se na vývoj na různých mobilních a maximalizace kód znovu použít, a přitom zajistit, že činnost koncového uživatele je nejvyšší prioritou|
|[Everis](http://www.everis.com)|Londýn, Spojené království|Everis je nadnárodní konzultační firma, která nabízí firmy a strategické řešení, vývoj a údržbu technologické aplikací a služeb outsourcingu|
|[Fujitsu](http://www.fujitsu.com/uk/services/application-services/application-development-integration/)||Fujitsu je přední japonské informační a komunikační technologie společnosti nabízejí celou řadu produktů využívajících technologie, řešení a služeb|
|[Futurice](http://futurice.com)|Londýn, Spojené království; Mnichově, Německo Helskinki, Finsko|Od 2001 Futurice pracoval na více než jeden tisíc projekty s více než 200 zákazníků. Věděli, jak generovat inovativní nápady a proměnit je software, který funguje|
|[Skupiny Groove](http://www.groveis.com/)|Londýn, Spojené království; Johannesburg, Jihoafrická republika|Na Groove jsme odemknout podnikání díky technologii. Pomůžeme vám a vaší firmy splnění svůj potenciál prostřednictvím sílu špičkový Cloud computingu, vlastní vývoj softwaru, zabezpečení a analýzy|
|[Guimak Ltd.](http://www.guimak.com)|Londýn, Spojené království|Společnost vývoj her|
|[V dolním Ltd](http://inthehand.com )|Newport, Shropshire, Spojené království|Ruční Ltd. vytvoří aplikace a komponenty pro mobilní zařízení, smíšené reality a systémy IoT|
|[Služba BITS iOS](http://iosbits.co.uk)|Londýn, Spojené království|iOS bitů mobilní inovace předpokladů. Věděli, jak vytvořit výkonné uživatelské prostředí a nástroje pro obchodní creative pomocí nově vznikající technologie|
|[iScientia Limited](http://www.iscientia.co.uk/)|Surrey, Spojené království|Nabízíme poradenství systémy informace a řešení, hlavně pro obory, pohostinství, maloobchodní prodej a platba.|
|[Trvání (mikrosekundy)](http://www.microsec.co.uk/)|Hampshire, Spojené království|Během posledních tří desetiletí trvání (mikrosekundy) mají určená, vyvinul a které podporuje softwarová řešení pomocí prakticky každé technologie v všeobecné použití.|
|[Motech Ltd.](http://www.motechltd.com)|Londýn, Spojené království; Riga, Lotyšsko|Motech Ltd firemní mobilní řešení je mezinárodní technologická společnost, využití 12 + let zkušenosti z hlediska organizace doručování aplikací pro globální společnosti, aby poskytovaly nejlepší poměr Enterprise Mobile Apps|
|[Bod správy Ltd](http://pml.co.uk)|Solihull Midlands – Západ, Velká Británie|Projekty společnosti PML zahrnovaly podnikové, komerční a vzdělávací aplikace. Hlavní činnost vaší společnosti span více programovacích jazyků, nativních mobilních aplikací a vývoje pro cloud, komplexní zabezpečení systémů, obrázků, videí komprese a streamování. |
|[Proto softwaru](https://www.protosoftware.co.uk/)|Spojené království|Vyvíjíme mobilní aplikace pro vaši firmu na celou řadu platforem včetně iOS, Android a Windows získáte tak dosahu více než 3 miliardy potenciálních zákazníků. |
|[Zřídka nemožné](http://www.rarelyimpossible.com)|Bournemouth, Spojené království|Zřídka nemožné nápovědy společnosti vytvářet mobilní aplikace a cloudové řešení IoT k řešení obchodních problémů, se zaměřením na činnost uživatele během fáze návrhu a vývoje. Naším cílem je prostřednictvím projektů a produkty, které se nám vytvořit pro naše klienty pro všechny v organizaci pomocí nástrojů, které pomáhají při jejich každý den.|
|[Rock Solid znalostní báze](http://www.rocksolidknowledge.com)|Bristol, Spojené království|Jak partneři Xamarin můžeme sestavit pro různé platformy mobilní řešení využívající Xamarin Forms a nativním uživatelským rozhraním v Iosu a Androidu. Nepovedlo se zkušeným při vývoji řešení, které jsou užitečné, že nativním uživatelským rozhraním pocit, že při sdílení všechny nebo skvělou řešit kódu mezi platformami.|
|[Screenmedia](http://www.screenmedia.co.uk)|Glasgow, Spojené království|Screenmedia domnívá, že k vytváření řešení středem lidských pro klienty a koncovým uživatelům, musí být lidské soustředí firmy. Jejich vize a hodnoty plně odrážel a přirozeně, proto jejich lidé. Postup Screenmedia pro jazykovou verzi je klíčem k jejich úspěchu. To "Äôs co řídí a utrpí jejich inovací v nově vznikající technologie; pomáhá vytvoří agilní partnerství s klienty; a to "Äôs kvůli tomu velmi náročné práce prostřednictvím.|
|[Pořadí](https://www.sequence.co.uk/)|Cardiffu, Spojené království; Londýn, Spojené království|Sekvence je creative digitální agentura v roce 1995. Specializující se na design, strategie a činnost koncového uživatele, že jste pracovali s některé z největších organizace Britském v oborech, od výrobní ruchu. Připojování značky se svými zákazníky prostřednictvím nadšení a inovací.|
|[ShinobiSolutions](https://www.shinobicontrols.com/shinobienterprise)|Newcastleské upon Tyne, Spojené království|Od svého vzniku v roce 2011 má již Shinobicontrols vytvářeli komplexní a výkonný interaktivní ovládací prvky uživatelského rozhraní pro iOS a vývojáři pro Android. 2012 se spustí shinobicharts, jejich první produktu. Od té doby se "Äôve vypěstovaná rychle a teď poskytují uživatelského rozhraní řešení až po tisíce zákazníků s naší portfoliem rychle se zvětšujícího produktů.|
|[Skillweb](http://www.skillweb.co.uk)|Vysoce Wycombe, Spojené království|Skillweb je soukromých, na základě Velká Británie firma, která poskytuje technologii řešení navržená tak, aby pomáhají organizacím spravovat jejich mobilní sil a sledování pohybu jejich zboží. Společnost provozuje od 1999 správu nasazení ve Spojeném království a Evropě a je zodpovědný za až 100 milionů transakcí každý měsíc a stále se rozšiřujících.|
|[Software vyřešit](http://www.softwaresolved.com/)|Exeter, Spojené království; Londýn, Spojené království; Manchester, Velká Británie|Dlouhodobé partnerství při sestavování našich klientů na základě vztahu důvěryhodnosti a doručování vynikající softwaru. Jsme Gold partnera společnosti Microsoft a naši procesy jsou certifikace ISO 9001.  To znamená, že jsme jsou schválené s nejvyšší standardy kvality ve vývoji softwaru.|
|[StyleTech](https://www.styletech.co.uk/)|Trupu, Spojené království|Máme specialisty sled prací softwaru vývoj špičkových, přizpůsobené řešení, aby odpovídala našim zákazníkům Äô požadavkům současně také podporuje, údržbu a vylepšování starší verze systémů. Operační od 1999 jsme boast záznam sledovat doručování více než 1000 sled prací softwarových projektů pro nejrůznějším klienty z veřejné a privátní sektory, jsme specializují zdravotní péče, vědecká, přenosu, výrobní a technologie odvětví. S popisné a srozumitelné kulturu poskytujeme vždy cílené, kvalitu služby pro všechny naše zákazníky. Práce s Xamarinem, Xamarin Test Cloud a Azure jsme odborníků na mobilních zařízeních, tablet, vývoj pro cloud, web nebo desktop a vždy použijte osvědčeným postupem k oblastem analýzy, návrh, zabezpečení, testování a integrace.|
|[Superluminal](http://www.superluminalsoftware.co.uk)|Oxford, Spojené království|Tady na Superluminal jsme softwarové inženýry, proto jsme návrh náš software od začátku, vytváření důležité systémy, které vedou k procesu a hyper poplatky vaši firmu. Můžeme také udržovat a upgradujte váš aktuální systém, pokud jeho spuštění, který brání nebo vyžaduje změnu podle potřeb firmy.|
|[Bespoke společnosti omezené aplikace](http://www.thebespokeappcompany.co.uk)|Barrowford, Spojené království; District Leicestershire – sever – Západ, Velká Británie||
|[Thumbmunkeys Ltd](http://www.thumbmunkeys.com)|York Yorkshire, Velká Británie – sever|Pomocí sledování záznam, který zahrnuje vytvoření uživatelských aplikací s více než 30 milionů souborů ke stažení Thumbmunkeys vědět, jak vytvoření skutečně výjimečného a zapojení uživatelů mobilní prostředí. Naše UK založené tým odborníků vývojářů a návrhářů nabízejí řešení přizpůsobené začátku do konce na konzultaci k vytváření prototypů, uživatelské rozhraní a prostředí návrh, vývoj pro různé platformy, vývoje pro cloud a probíhající technickou podporu.|
|[VoxDev Ltd](http://www.voxdevmobile.com)|Durhamovy, Spojené království|VoxDev byl vytvořen v roce 2003 a z naší base v Durhamovy v Anglii of Východ severní jsme úspěšně pomohly klientů s své softwarové projekty vytváření webu, desktopové nebo mobilní aplikace.|
|[Waterstons LTD](https://waterstons.com)|Durhamovy, Spojené království|Vytvářejte lepší byznys. Pomocí technologie, prostředí a závazku Waterstons spolupracuje s stovky klientů, velké a malé, ke zlepšení jejich podnikání.|
|[Rozbalit IT](http://www.xpand-it.com)|Lisabon, Portugalsko Londýn, Spojené království|S několika let zkušeností v mobilním světě a k dispozici víc než 130 Mobile Apps v rámci různých Tržiště rozbalit je jeden z lídrů na podnikových mobilních aplikací služeb.|
|[YARG Limited](http://www.yarg.com)|Londýn, Spojené království|YARG vyvíjí multiplatformní mobilní aplikace pro iPhone, iPad, Android a Windows Phone. Jejich pride chceme na poskytnutí hodnoty, kvalitu produktu a vysokou úroveň osobní služby.|
|[Systémy Zepto omezené](http://www.zeptosystems.com )|Londýn, Spojené království|Transformace outsourcing a offshoring inteligentní sourcing. Zvýšení interních kapacit a znalosti vzdálení zaměstnanci ušetříte čas, nákladů (až 60 %), pronájem a zachování.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[FreezePro softwaru](http://freezeprosoftware.com)|Lviv, Ukrajina|Vývoj vlastního softwaru poskytuje společnosti outsourcing je FreezePro softwaru. Bylo zjištěno enterprising odborníkům silné pozadí IT.|
|[Inovace v oblasti omezeného grafického uživatelského rozhraní](http://www.gui-innovations.com)|Kyjev, Ukrajina|Poskytujeme softwarová řešení pro mobilní svět. Máme jedinečná zkušenosti z hlediska návrhu, vývoji a podpoře software pro mnoho platforem|
|[Neadevis](http://neadevis.com/)|Lviv, Ukrajina|Řešení vysoké kvality a spokojenost zákazníka jsou základní naši firmu. Naše klientů v Upwork uveďte skóre špičkového zpětnou vazbu. Další informace o klientech jsou názory nám.|
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[Nareia](http://nareia.com.uy)|Uruguay|Usilujeme pro mobilní svět, velmi rádi vytvářet úžasné aplikace pro iOS a Android a máme skvělé prostředí na vývoj pro mobilní zařízení pomocí Xamarinu.  |
...
| Partner | umístění | Popis |
| --- | --- | --- |
|[DVLUP](http://www.dvlup.net/)|Ho či Minovo Město, Vietnam|Vývoj nahoru byla cílem úrovně Vietnamu vývojáři se Ruska vedoucích představitelů komunity vývojářů|
|[FPT Software Hanoj společnosti Limited](http://www.fpt-software.com/)|Hanoj, Vietnam|Je největší Vietnamu a jedna z nejrychleji se rozvíjejících zprostředkovatele služeb digitální transformace.|
